...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/iOS-modularization/WPXMediator"
  ...
  s.source       = { :git => "https://github.com/iOS-modularization/WPXMediator.git", :tag => s.version.to_s }
  ...
  s.source_files  = "WPXMediator/WPXMediator/**/*.{h,m,swift}"
